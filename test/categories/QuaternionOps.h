...
TEST(QuaternionOps, QuatToMat4)
{
    ...
    EXPECT_NEAR(result.Data[0][0], 1.0f, abs_error);
    EXPECT_NEAR(result.Data[0][1], 0.0f, abs_error);
    EXPECT_NEAR(result.Data[0][2], 0.0f, abs_error);
    EXPECT_NEAR(result.Data[0][3], 0.0f, abs_error);

    EXPECT_NEAR(result.Data[1][0], 0.0f, abs_error);
    EXPECT_NEAR(result.Data[1][1], 0.0f, abs_error);
    EXPECT_NEAR(result.Data[1][2], 1.0f, abs_error);
    EXPECT_NEAR(result.Data[1][3], 0.0f, abs_error);

    EXPECT_NEAR(result.Data[2][0], 0.0f, abs_error);
    EXPECT_NEAR(result.Data[2][1], -1.0f, abs_error);
    EXPECT_NEAR(result.Data[2][2], 0.0f, abs_error);
    EXPECT_NEAR(result.Data[2][3], 0.0f, abs_error);

    EXPECT_NEAR(result.Data[3][0], 0.0f, abs_error);
    EXPECT_NEAR(result.Data[3][1], 0.0f, abs_error);
    EXPECT_NEAR(result.Data[3][2], 0.0f, abs_error);
